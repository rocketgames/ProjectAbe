...
/// <summary>
/// Extending MonoBehaviour to add some extra functionality (http://zingweb.com/blog/2013/02/05/unity-coroutine-wrapper/)
...
public class TTMonoBehaviour : MonoBehaviour
{
	...
	public class Coroutine<T>
	{
		...
		public Coroutine(string lockID, float waitTime, LockQueue lockedCoroutines)
		{
            ...
            // set a new id if null
			this.lockID = (! string.IsNullOrEmpty(lockID)) ? lockID : Guid.NewGuid().ToString();
