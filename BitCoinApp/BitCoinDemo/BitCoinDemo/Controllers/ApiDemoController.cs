    ...
    public class ApiDemoController : ApiController
    {
       // [AcceptVerbs("Get","GetSomething/id")]
        ...
        public AuthKey GetAuthenticationKey(string url, string key, string currentTime ) {
            ...
            DateTime ThisMoment = DateTime.Now.ToUniversalTime();
            //2014-06-23T03:10:04.905376
            DateTime CurrentMoment = DateTime.Now;
            string finalDate = string.Format("2015-01-12T{0}:{1}.{2}", CurrentMoment.Hour, CurrentMoment.Minute, CurrentMoment.Second) ;
           // string dateFormatted = new DateTime(ThisMoment.Year, ThisMoment.Month, ThisMoment.Day, ThisMoment.Hour, ThisMoment.Minute, ThisMoment.Second, ThisMoment.Millisecond, DateTimeKind.Unspecified).ToString();
            DateTime theUTCTime = DateTime.Now.ToUniversalTime();
            string myTime = currentTime == null ? "2014-06-03T17:48:47.774453" : finalDate;
