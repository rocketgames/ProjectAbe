...
/// <summary>
/// Combine mono singleton and TTMonoBehaviour
/// </summary>
public abstract class TTMonoSingleton<T> : TTMonoBehaviour where T : TTMonoSingleton<T>
{
    #region Variables
    ...
    private void Awake()
    {
        ...
        {
            Debug.Log(string.Format("ERROR: {0}", excep.Message));
        }
    }
